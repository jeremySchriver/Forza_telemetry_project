...
class DataPacket():
    ...
    # Dash format (FM8)
    _dash_format_fm8 = _default_format + '17fH6B3b4fi'
    ...
    def __init__(self, version):
        '''
            ...
            (version = sled, dash, fh4+,dash_fm8)
        '''
        ...
        elif self.packet_version == 'dash_fm8':
            self._packet_format = self._dash_format_fm8
    ...
    def _get_dash_fm8_attributes(self):
        '''Returns the dash attributes (FM8)'''
        return [
            # Tire wear data
            'tire_wear_front_left', 'tire_wear_front_right', 'tire_wear_rear_left', 'tire_wear_rear_right',
            # Track ID
            'track_ordinal_id'
        ]
